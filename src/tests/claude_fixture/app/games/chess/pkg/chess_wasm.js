...
export class ChessEngine {
     ...
     * @returns {any}
     */
    get_best_move(max_depth) {
        const ret = wasm.chessengine_get_best_move(this.__wbg_ptr, max_depth);
        return ret;
    }
    constructor() {
    ...
    reset_board() {
        wasm.chessengine_reset_board(this.__wbg_ptr);
    }
    /**
     * @param {Int32Array} board_flat
     * @param {number} turn
     */
    update_board(board_flat, turn) {
        const ptr0 = passArray32ToWasm0(board_flat, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.chessengine_update_board(this.__wbg_ptr, ptr0, len0, turn);
    }
}
